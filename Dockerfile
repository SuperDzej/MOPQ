...
WORKDIR /home/mopquestionnaire

# Install MOPQ Prerequisites
RUN npm install -g grunt-cli && npm install -g bower

# Install MOPQ packages
ADD package.json /home/mopquestionnaire/package.json
#RUN npm install

# Manually trigger bower
ADD .bowerrc /home/mopquestionnaire/.bowerrc
ADD bower.json /home/mopquestionnaire/bower.json
RUN bower install --config.interactive=false --allow-root

# Make everything available for start
ADD . /home/mopquestionnaire
