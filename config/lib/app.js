...
module.exports.start = function start(callback) {
  ...
  _this.init(function(app, db, config) {
    ...
    app.listen(config.port, function() {
      ...
      console.info(chalk.green('App version:\t\t') + config.mopquestionnaire.version);

      if (config.mopquestionnaire['mopquestionnaire-version']) {
        console.log(chalk.green('SEAN.JS version:\t') + config.mopquestionnaire['mopquestionnaire-version']);
      }
